...
export default function FirstParagraph(){
  return(
    <div className="flex flex-col lg:flex-row items-center justify-center mt-8 mx-16 lg:mx-8">
      <div className="flex-1 flex justify-center items-center">
        <Image
          ...
          width={650}
          height={490}
          className="block border-box rounded-2xl border-primary border-[3px] mb-6 lg:mb-8 mt-4 lg:mt-8 align-middle max-w-full"
        />
      </div>
      <div className="mt-8 lg:mt-0 flex-1 text-center lg:text-left">
        <Title text={"Pourquoi nous choisir ?"} />
        <ul className="list-disc ml-4 lg:ml-6 text-justify">
